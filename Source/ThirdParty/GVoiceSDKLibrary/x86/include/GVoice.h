...
{
    Event_Unknown = 0, // unknown event
    Event_NewDeviceAvailable = 11, // a new headset or buletooth device be connected
    Event_OldDeviceUnavailable = 10, // a new headset or buletooth device be disconnected
    Event_NoSuitableDeviceAvailable = 12, // have not any sutiable devices be connected
